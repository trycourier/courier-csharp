...
public class WorkspacePreferenceReplaceRequestTest : TestBase
{
    [Fact]
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<WorkspacePreferenceReplaceRequest>(
            json,
    ...
    public void CopyConstructor_Works()
    {
        ...
        WorkspacePreferenceReplaceRequest copied = new(model);
