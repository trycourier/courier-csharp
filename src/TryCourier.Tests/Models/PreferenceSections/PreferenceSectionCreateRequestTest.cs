...
public class PreferenceSectionCreateRequestTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new PreferenceSectionCreateRequest
        {
            Name = "name",
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<PreferenceSectionCreateRequest>(
            json,
    ...
    {
        var model = new PreferenceSectionCreateRequest { Name = "name" };
    ...
    public void CopyConstructor_Works()
    {
        ...
        PreferenceSectionCreateRequest copied = new(model);
