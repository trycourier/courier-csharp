...
public class PreferenceTopicCreateRequestTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new PreferenceTopicCreateRequest
        {
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<PreferenceTopicCreateRequest>(
            json,
    ...
    public void CopyConstructor_Works()
    {
        ...
        PreferenceTopicCreateRequest copied = new(model);
