...
public class PreferenceSectionReplaceParamsTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var parameters = new PreferenceSectionReplaceParams
        {
    ...
    {
        PreferenceSectionReplaceParams parameters = new()
        {
            SectionID = "section_id",
            Name = "name",
        };
    ...
    public void CopyConstructor_Works()
    {
        ...
        PreferenceSectionReplaceParams copied = new(parameters);
