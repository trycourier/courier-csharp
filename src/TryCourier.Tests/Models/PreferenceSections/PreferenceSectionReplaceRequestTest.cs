...
public class PreferenceSectionReplaceRequestTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new PreferenceSectionReplaceRequest
        {
            Name = "name",
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<PreferenceSectionReplaceRequest>(
            json,
    ...
    {
        var model = new PreferenceSectionReplaceRequest { Name = "name" };
    ...
    public void CopyConstructor_Works()
    {
        ...
        PreferenceSectionReplaceRequest copied = new(model);
