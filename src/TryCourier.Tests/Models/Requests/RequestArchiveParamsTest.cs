using System;
using TryCourier.Models.Requests;

namespace TryCourier.Tests.Models.Requests;
...
public class RequestArchiveParamsTest : TestBase
{
    ...
    public void Url_Works()
    {
        ...
        Assert.True(
            TestBase.UrisEqual(new Uri("https://api.courier.com/requests/request_id/archive"), url)
        );
    }
