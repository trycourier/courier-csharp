...
public class RoutingStrategyCreateRequestTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new RoutingStrategyCreateRequest
        {
            Name = "name",
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<RoutingStrategyCreateRequest>(
            json,
    ...
    public void CopyConstructor_Works()
    {
        ...
        RoutingStrategyCreateRequest copied = new(model);
