...
public class JourneyRunListItemTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new JourneyRunListItem
        {
            RunID = "run_id",
            Source = ["string"],
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<JourneyRunListItem>(
            json,
    ...
    {
        var model = new JourneyRunListItem { RunID = "run_id", Source = ["string"] };
    ...
    public void CopyConstructor_Works()
    {
        ...
        JourneyRunListItem copied = new(model);
