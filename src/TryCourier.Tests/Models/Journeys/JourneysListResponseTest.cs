...
public class JourneysListResponseTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new JourneysListResponse
        {
            Cursor = "cursor",
            Templates =
            [
        ...
        List<Journey> expectedTemplates =
        [
            new()
            {
                ID = "id",
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<JourneysListResponse>(
            json,
    ...
    public void CopyConstructor_Works()
    {
        ...
        JourneysListResponse copied = new(model);
