...
public class TemplatePutLocaleParamsTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var parameters = new TemplatePutLocaleParams
        {
            TemplateID = "x",
            NotificationID = "x",
            LocaleID = "x",
    ...
    public void Url_Works()
    {
        ...
        Assert.True(
            TestBase.UrisEqual(
                new Uri("https://api.courier.com/journeys/x/templates/x/locales/x"),
                url
            )
        );
    }
    ...
    public void CopyConstructor_Works()
    {
        ...
        TemplatePutLocaleParams copied = new(parameters);
