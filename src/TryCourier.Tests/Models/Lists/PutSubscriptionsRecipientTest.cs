...
namespace TryCourier.Tests.Models.Lists;

public class PutSubscriptionsRecipientTest : TestBase
{
    [Fact]
    ...
    {
        var model = new PutSubscriptionsRecipient { RecipientID = "recipientId" };
