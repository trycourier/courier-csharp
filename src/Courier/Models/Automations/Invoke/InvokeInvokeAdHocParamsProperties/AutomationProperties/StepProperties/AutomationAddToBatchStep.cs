...
[JsonConverter(typeof(ModelConverter<AutomationAddToBatchStep>))]
public sealed record class AutomationAddToBatchStep : ModelBase, IFromRaw<AutomationAddToBatchStep>
{
    public string? If
    {
        get
    ...
    ) => new() { If = automationAddToBatchStep.If, Ref = automationAddToBatchStep.Ref };
    ...
    public AutomationAddToBatchStep() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    AutomationAddToBatchStep(Dictionary<string, JsonElement> properties)
    {
        Properties = properties;
    }
#pragma warning restore CS8618

    public static AutomationAddToBatchStep FromRawUnchecked(
