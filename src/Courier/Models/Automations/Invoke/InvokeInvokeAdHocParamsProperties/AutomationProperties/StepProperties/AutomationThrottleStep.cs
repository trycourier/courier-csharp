...
using IntersectionMember1Properties = Courier.Models.Automations.Invoke.InvokeInvokeAdHocParamsProperties.AutomationProperties.StepProperties.AutomationThrottleStepProperties.IntersectionMember1Properties;

namespace Courier.Models.Automations.Invoke.InvokeInvokeAdHocParamsProperties.AutomationProperties.StepProperties;

[JsonConverter(typeof(ModelConverter<AutomationThrottleStep>))]
public sealed record class AutomationThrottleStep : ModelBase, IFromRaw<AutomationThrottleStep>
{
    public string? If
    {
        get
    ...
    public static implicit operator AutomationStep(AutomationThrottleStep automationThrottleStep) =>
        new() { If = automationThrottleStep.If, Ref = automationThrottleStep.Ref };
    ...
    public AutomationThrottleStep() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    AutomationThrottleStep(Dictionary<string, JsonElement> properties)
    {
        Properties = properties;
    }
#pragma warning restore CS8618

    public static AutomationThrottleStep FromRawUnchecked(
