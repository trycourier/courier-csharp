...
public sealed record class ListListParams : ParamsBase
{
    ...
    public string? Pattern
    {
        get
        {
            if (!this._rawQueryData.TryGetValue("pattern", out JsonElement element))
                return null;
        ...
        init
        {
            this._rawQueryData["pattern"] = JsonSerializer.SerializeToElement(
                value,
                ModelBase.SerializerOptions
            );
        }
...
#pragma warning restore CS8618
    ...
    {
        return new UriBuilder(options.BaseUrl.ToString().TrimEnd('/') + "/lists")
        {
