...
using Courier.Models.Lists.Subscriptions.RecipientPreferencesProperties.CategoriesProperties.CategoriesItemProperties;
using Courier.Models.Users.Preferences;
using Generic = System.Collections.Generic;

namespace Courier.Models.Lists.Subscriptions.RecipientPreferencesProperties.CategoriesProperties;
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    CategoriesItem(Generic::Dictionary<string, JsonElement> properties)
    {
        Properties = properties;
    }
#pragma warning restore CS8618

    public static CategoriesItem FromRawUnchecked(
