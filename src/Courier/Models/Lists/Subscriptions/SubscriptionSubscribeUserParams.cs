...
/// </summary>
public record class SubscriptionSubscribeUserParams : ParamsBase
{
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    public SubscriptionSubscribeUserParams(
        SubscriptionSubscribeUserParams subscriptionSubscribeUserParams
    )
        : base(subscriptionSubscribeUserParams)
    {
...
#pragma warning restore CS8618
    ...
    public virtual bool Equals(SubscriptionSubscribeUserParams? other)
    {
        if (other == null)
        {
            return false;
