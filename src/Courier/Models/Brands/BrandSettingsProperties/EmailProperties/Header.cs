...
using Courier.Models.Brands.BrandSettingsProperties.EmailProperties.HeaderProperties;

namespace Courier.Models.Brands.BrandSettingsProperties.EmailProperties;

[JsonConverter(typeof(ModelConverter<Header>))]
public sealed record class Header : ModelBase, IFromRaw<Header>
{
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    Header(Dictionary<string, JsonElement> properties)
    {
        Properties = properties;
    }
#pragma warning restore CS8618

    public static Header FromRawUnchecked(Dictionary<string, JsonElement> properties)
    {
        return new(properties);
    }

    [SetsRequiredMembers]
    public Header(Logo logo)
        : this()
    {
        this.Logo = logo;
    }
