...
[JsonConverter(typeof(ModelConverter<Head>))]
public sealed record class Head : ModelBase, IFromRaw<Head>
{
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    Head(Dictionary<string, JsonElement> properties)
    {
        Properties = properties;
    }
#pragma warning restore CS8618

    public static Head FromRawUnchecked(Dictionary<string, JsonElement> properties)
    {
        return new(properties);
    }

    [SetsRequiredMembers]
    public Head(bool inheritDefault)
        : this()
    {
