...
/// </summary>
public record class ListSubscribeParams : ParamsBase
{
    ...
    public required IReadOnlyList<SubscribeToListsRequestItem> Lists
    {
        get
        {
            ...
            return this._rawBodyData.GetNotNullStruct<ImmutableArray<SubscribeToListsRequestItem>>(
                "lists"
            );
        }
        init
        {
            this._rawBodyData.Set<ImmutableArray<SubscribeToListsRequestItem>>(
                "lists",
...
#pragma warning disable CS8618
        ...
        : base(listSubscribeParams)
    {
        ...
        this._rawBodyData = new(listSubscribeParams._rawBodyData);
    }
...
#pragma warning restore CS8618
    ...
    public virtual bool Equals(ListSubscribeParams? other)
    {
        if (other == null)
        {
            return false;
