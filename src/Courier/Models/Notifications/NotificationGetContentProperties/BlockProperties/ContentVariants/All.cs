using Courier.Core;
using ContentProperties = Courier.Models.Notifications.NotificationGetContentProperties.BlockProperties.ContentProperties;

namespace Courier.Models.Notifications.NotificationGetContentProperties.BlockProperties.ContentVariants;
