...
using Courier.Core;
using Courier.Models.Notifications.NotificationContentProperties;

namespace Courier.Models.Notifications;

[JsonConverter(typeof(ModelConverter<NotificationContent>))]
public sealed record class NotificationContent : ModelBase, IFromRaw<NotificationContent>
{
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    NotificationContent(Dictionary<string, JsonElement> properties)
    {
        Properties = properties;
    }
#pragma warning restore CS8618

    public static NotificationContent FromRawUnchecked(Dictionary<string, JsonElement> properties)
    {
