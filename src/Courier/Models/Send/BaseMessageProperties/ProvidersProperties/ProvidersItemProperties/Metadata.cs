...
using Courier.Core;
using Courier.Models.Send.BaseMessageProperties.ProvidersProperties.ProvidersItemProperties.MetadataProperties;

namespace Courier.Models.Send.BaseMessageProperties.ProvidersProperties.ProvidersItemProperties;
