...
using Courier.Core;
using ProvidersItemProperties = Courier.Models.Send.BaseMessageProperties.ProvidersProperties.ProvidersItemProperties;

namespace Courier.Models.Send.BaseMessageProperties.ProvidersProperties;
