...
using ExpiresInVariants = Courier.Models.Send.BaseMessageProperties.ExpiryProperties.ExpiresInVariants;

namespace Courier.Models.Send.BaseMessageProperties.ExpiryProperties;
