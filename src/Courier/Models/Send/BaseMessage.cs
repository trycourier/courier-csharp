...
[JsonConverter(typeof(ModelConverter<BaseMessage>))]
public sealed record class BaseMessage : ModelBase, IFromRaw<BaseMessage>
{
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    BaseMessage(Dictionary<string, JsonElement> properties)
    {
        Properties = properties;
    }
#pragma warning restore CS8618

    public static BaseMessage FromRawUnchecked(Dictionary<string, JsonElement> properties)
    {
