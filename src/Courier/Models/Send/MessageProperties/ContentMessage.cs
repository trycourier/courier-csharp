...
/// chat, or any channel.
/// </summary>
[JsonConverter(typeof(ModelConverter<ContentMessage>))]
public sealed record class ContentMessage : ModelBase, IFromRaw<ContentMessage>
{
    ...
    public static implicit operator BaseMessage(ContentMessage contentMessage) =>
        new()
        {
    ...
    public static implicit operator BaseMessageSendTo(ContentMessage contentMessage) =>
        new() { To = contentMessage.To };
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    ContentMessage(Dictionary<string, JsonElement> properties)
    {
        Properties = properties;
    }
#pragma warning restore CS8618

    public static ContentMessage FromRawUnchecked(Dictionary<string, JsonElement> properties)
    {
