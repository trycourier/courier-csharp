...
namespace Courier.Models.Send.MessageProperties;
...
/// </summary>
[JsonConverter(typeof(ModelConverter<TemplateMessage>))]
public sealed record class TemplateMessage : ModelBase, IFromRaw<TemplateMessage>
{
    ...
    public static implicit operator BaseMessage(TemplateMessage templateMessage) =>
        new()
        {
    ...
    public static implicit operator BaseMessageSendTo(TemplateMessage templateMessage) =>
        new() { To = templateMessage.To };
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    TemplateMessage(Dictionary<string, JsonElement> properties)
    {
        Properties = properties;
    }
#pragma warning restore CS8618

    public static TemplateMessage FromRawUnchecked(Dictionary<string, JsonElement> properties)
    {
