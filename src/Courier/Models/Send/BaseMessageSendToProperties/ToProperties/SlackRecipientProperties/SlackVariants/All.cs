using Courier.Core;
using SlackProperties = Courier.Models.Send.BaseMessageSendToProperties.ToProperties.SlackRecipientProperties.SlackProperties;

namespace Courier.Models.Send.BaseMessageSendToProperties.ToProperties.SlackRecipientProperties.SlackVariants;
