...
namespace Courier.Models.Send.BaseMessageSendToProperties.ToProperties.SlackRecipientProperties.SlackProperties.SendToSlackEmailProperties;
...
#pragma warning restore CS8618
    ...
    [SetsRequiredMembers]
    public IntersectionMember1(string email)
        : this()
    {
        this.Email = email;
    }
