...
namespace Courier.Models.Send.BaseMessageSendToProperties.ToProperties.MsTeamsRecipientProperties.MsTeamsProperties.SendToMsTeamsConversationIDProperties;
...
#pragma warning restore CS8618
    ...
    [SetsRequiredMembers]
    public IntersectionMember1(string conversationID)
        : this()
    {
