...
using Courier.Models.Send.SendSendMessageParamsProperties.MessageProperties.ToProperties.UnionMember0Properties.PreferencesProperties.CategoriesProperties.CategoriesItemProperties;

namespace Courier.Models.Send.SendSendMessageParamsProperties.MessageProperties.ToProperties.UnionMember0Properties.PreferencesProperties.CategoriesProperties;

[JsonConverter(typeof(ModelConverter<CategoriesItem>))]
public sealed record class CategoriesItem : ModelBase, IFromRaw<CategoriesItem>
{
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    CategoriesItem(Dictionary<string, JsonElement> properties)
    {
        Properties = properties;
    }
#pragma warning restore CS8618

    public static CategoriesItem FromRawUnchecked(Dictionary<string, JsonElement> properties)
    {
        return new(properties);
    }

    [SetsRequiredMembers]
    public CategoriesItem(ApiEnum<string, Status> status)
        : this()
    {
        this.Status = status;
    }
