...
using Courier.Core;
using ProvidersItemProperties = Courier.Models.Send.SendSendMessageParamsProperties.MessageProperties.ProvidersProperties.ProvidersItemProperties;

namespace Courier.Models.Send.SendSendMessageParamsProperties.MessageProperties.ProvidersProperties;
