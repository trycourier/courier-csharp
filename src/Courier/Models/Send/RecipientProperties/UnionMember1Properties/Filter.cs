...
using Courier.Models.Send.RecipientProperties.UnionMember1Properties.FilterProperties;

namespace Courier.Models.Send.RecipientProperties.UnionMember1Properties;
