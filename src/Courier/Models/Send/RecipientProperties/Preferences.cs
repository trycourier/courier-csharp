...
using Courier.Models.Send.RecipientProperties.PreferencesProperties.CategoriesProperties;
using Courier.Models.Send.RecipientProperties.PreferencesProperties.NotificationsProperties;
