...
using Courier.Models.Send.RecipientProperties.AudienceRecipientProperties.FilterProperties;

namespace Courier.Models.Send.RecipientProperties.AudienceRecipientProperties;
...
public sealed record class Filter : ModelBase, IFromRaw<Filter>
{
    ...
    public required ApiEnum<string, Path> Path
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<ApiEnum<string, Path>>(
                element,
                ModelBase.SerializerOptions
            );
        }
