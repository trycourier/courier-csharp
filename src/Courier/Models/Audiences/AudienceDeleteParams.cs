...
/// </summary>
public record class AudienceDeleteParams : ParamsBase
{
...
#pragma warning disable CS8618
    ...
    {
        this.AudienceID = audienceDeleteParams.AudienceID;
    }
...
#pragma warning restore CS8618
    ...
    public static AudienceDeleteParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData
    )
    {
    ...
    public virtual bool Equals(AudienceDeleteParams? other)
    {
        if (other == null)
        {
            return false;
