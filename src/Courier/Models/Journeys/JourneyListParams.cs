...
/// </summary>
public record class JourneyListParams : ParamsBase
{
    /// <summary>
    ...
    public JourneyListParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public JourneyListParams(JourneyListParams journeyListParams)
        : base(journeyListParams) { }
...
#pragma warning restore CS8618
    ...
    public static JourneyListParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData
    )
    {
    ...
    public virtual bool Equals(JourneyListParams? other)
    {
        if (other == null)
        {
            return false;
    ...
    {
        return new System::UriBuilder(options.BaseUrl.ToString().TrimEnd('/') + "/journeys")
        {
