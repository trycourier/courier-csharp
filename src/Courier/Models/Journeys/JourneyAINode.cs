...
public sealed record class JourneyAINode : JsonModel
{
    ...
    public required ApiEnum<string, global::Courier.Models.Journeys.Type> Type
    {
        get
        {
            this._rawData.Freeze();
            return this._rawData.GetNotNullClass<
                ApiEnum<string, global::Courier.Models.Journeys.Type>
            >("type");
        }
...
sealed class TypeConverter : JsonConverter<global::Courier.Models.Journeys.Type>
{
    public override global::Courier.Models.Journeys.Type Read(
    ...
    )
    {
        ...
        {
            "ai" => global::Courier.Models.Journeys.Type.AI,
            _ => (global::Courier.Models.Journeys.Type)(-1),
        };
    }

    public override void Write(
        Utf8JsonWriter writer,
        global::Courier.Models.Journeys.Type value,
        JsonSerializerOptions options
    )
    {
        JsonSerializer.Serialize(
            ...
            value switch
            {
                global::Courier.Models.Journeys.Type.AI => "ai",
