...
using Courier.Models.Messages.MessageGetContentResponseProperties.ResultProperties;

namespace Courier.Models.Messages.MessageGetContentResponseProperties;
