...
{
    public required Generic::List<Generic::Dictionary<string, JsonElement>> Results
    {
        get
        {
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    MessageHistoryResponse(Generic::Dictionary<string, JsonElement> properties)
    {
...
#pragma warning restore CS8618
    ...
    [SetsRequiredMembers]
    public MessageHistoryResponse(Generic::List<Generic::Dictionary<string, JsonElement>> results)
        : this()
    {
