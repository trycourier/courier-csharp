...
public record class UserProfileFirebaseToken
{
    ...
    public UserProfileFirebaseToken(string value, JsonElement? element = null)
    {
        this.Value = value;
        this._element = element;
    }

    public UserProfileFirebaseToken(IReadOnlyList<string> value, JsonElement? element = null)
    {
        this.Value = ImmutableArray.ToImmutableArray(value);
        this._element = element;
    }

    public UserProfileFirebaseToken(JsonElement element)
    {
        this._element = element;
    }
        ...
        switch (this.Value)
        {
            ...
            default:
                throw new CourierInvalidDataException(
                    "Data did not match any variant of UserProfileFirebaseToken"
                );
        }
    }
    ...
    public static implicit operator UserProfileFirebaseToken(string value) => new(value);

    public static implicit operator UserProfileFirebaseToken(List<string> value) =>
...
{
    public override UserProfileFirebaseToken? Read(
    ...
    public override void Write(
        ...
        UserProfileFirebaseToken value,
        JsonSerializerOptions options
    )
    {
