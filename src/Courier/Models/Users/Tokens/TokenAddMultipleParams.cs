...
/// </summary>
public record class TokenAddMultipleParams : ParamsBase
{
...
#pragma warning restore CS8618
    ...
    public static TokenAddMultipleParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData
    )
    {
    ...
    public virtual bool Equals(TokenAddMultipleParams? other)
    {
        if (other == null)
        {
            return false;
