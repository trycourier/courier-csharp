...
using Courier.Models.Tenants.Templates.ElementalContentProperties.ElementProperties;
using ElementVariants = Courier.Models.Tenants.Templates.ElementalContentProperties.ElementVariants;

namespace Courier.Models.Tenants.Templates.ElementalContentProperties;
...
public abstract record class Element
{
    ...
    public static implicit operator Element(UnionMember6 value) =>
        new ElementVariants::UnionMember6(value);
    ...
    {
        value = (this as ElementVariants::UnionMember6)?.Value;
        return value != null;
    }
    ...
    public void Switch(
        ...
        Action<ElementVariants::UnionMember6> unionMember6
    )
    {
        switch (this)
        {
            ...
            case ElementVariants::UnionMember5 inner:
                unionMember5(inner);
                break;
            case ElementVariants::UnionMember6 inner:
                unionMember6(inner);
                break;
            default:
    ...
    public T Match<T>(
        ...
        Func<ElementVariants::UnionMember6, T> unionMember6
    )
    {
        return this switch
        {
            ...
            ElementVariants::UnionMember6 inner => unionMember6(inner),
...
sealed class ElementConverter : JsonConverter<Element>
{
    ...
    )
    {
        ...
        try
        {
            ...
            if (deserialized != null)
            {
                return new ElementVariants::UnionMember6(deserialized);
            }
        }
        catch (JsonException e)
        {
            exceptions.Add(
                new CourierInvalidDataException(
                    "Data does not match union variant ElementVariants::UnionMember6",
                    e
                )
            );
        }
    ...
    public override void Write(Utf8JsonWriter writer, Element value, JsonSerializerOptions options)
    {
        object variant = value switch
        {
            ...
            ElementVariants::UnionMember6(var unionMember6) => unionMember6,
            _ => throw new CourierInvalidDataException("Data did not match any variant of Element"),
        };
