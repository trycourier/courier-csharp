using Courier.Core;
using ElementalNodeProperties = Courier.Models.Tenants.Templates.ElementalNodeProperties;

namespace Courier.Models.Tenants.Templates.ElementalNodeVariants;
