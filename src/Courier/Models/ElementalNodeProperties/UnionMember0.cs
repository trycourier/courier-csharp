...
using Courier.Core;
using Courier.Models.ElementalNodeProperties.UnionMember0Properties.IntersectionMember1Properties;
...
public sealed record class UnionMember0 : ModelBase, IFromRaw<UnionMember0>
{
    ...
    public static implicit operator ElementalBaseNode(UnionMember0 unionMember0) =>
        new()
        {
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    UnionMember0(Generic::Dictionary<string, JsonElement> properties)
    {
        Properties = properties;
    }
#pragma warning restore CS8618

    public static UnionMember0 FromRawUnchecked(Generic::Dictionary<string, JsonElement> properties)
    {
