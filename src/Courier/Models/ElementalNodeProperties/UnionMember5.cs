...
using Courier.Core;
using Courier.Models.ElementalNodeProperties.UnionMember5Properties.IntersectionMember1Properties;
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    UnionMember5(Generic::Dictionary<string, JsonElement> properties)
    {
        Properties = properties;
    }
#pragma warning restore CS8618

    public static UnionMember5 FromRawUnchecked(Generic::Dictionary<string, JsonElement> properties)
    {
