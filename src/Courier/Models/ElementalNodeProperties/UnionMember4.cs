...
using Courier.Core;
using Courier.Models.ElementalNodeProperties.UnionMember4Properties.IntersectionMember1Properties;
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    UnionMember4(Generic::Dictionary<string, JsonElement> properties)
    {
        Properties = properties;
    }
#pragma warning restore CS8618

    public static UnionMember4 FromRawUnchecked(Generic::Dictionary<string, JsonElement> properties)
    {
