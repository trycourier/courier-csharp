...
using Courier.Core;
using Courier.Models.ElementalNodeProperties.UnionMember3Properties.IntersectionMember1Properties;
...
public sealed record class UnionMember3 : ModelBase, IFromRaw<UnionMember3>
{
    ...
    public static implicit operator ElementalBaseNode(UnionMember3 unionMember3) =>
        new()
        {
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    UnionMember3(Generic::Dictionary<string, JsonElement> properties)
    {
        Properties = properties;
    }
#pragma warning restore CS8618

    public static UnionMember3 FromRawUnchecked(Generic::Dictionary<string, JsonElement> properties)
    {
