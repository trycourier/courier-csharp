...
/// </summary>
public record class AuditEventRetrieveParams : ParamsBase
{
...
#pragma warning restore CS8618
    ...
    public static AuditEventRetrieveParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData
    )
    {
    ...
    public override string ToString() =>
        JsonSerializer.Serialize(
            FriendlyJsonPrinter.PrintValue(
                ...
                {
                    ["AuditEventID"] = JsonSerializer.SerializeToElement(this.AuditEventID),
    ...
    public virtual bool Equals(AuditEventRetrieveParams? other)
    {
        if (other == null)
        {
            return false;
        }
        return (this.AuditEventID?.Equals(other.AuditEventID) ?? other.AuditEventID == null)
