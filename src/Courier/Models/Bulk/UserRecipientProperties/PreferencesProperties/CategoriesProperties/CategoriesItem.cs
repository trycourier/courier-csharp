...
using Courier.Models.Bulk.UserRecipientProperties.PreferencesProperties.CategoriesProperties.CategoriesItemProperties;
using Courier.Models.Users.Preferences;

namespace Courier.Models.Bulk.UserRecipientProperties.PreferencesProperties.CategoriesProperties;
...
#pragma warning restore CS8618
    ...
    [SetsRequiredMembers]
    public CategoriesItem(ApiEnum<string, PreferenceStatus> status)
        : this()
    {
        this.Status = status;
    }
