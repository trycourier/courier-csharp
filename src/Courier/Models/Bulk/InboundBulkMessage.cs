...
/// </summary>
[JsonConverter(typeof(ModelConverter<InboundBulkMessage, InboundBulkMessageFromRaw>))]
public sealed record class InboundBulkMessage : ModelBase
{
    /// <summary>
...
class InboundBulkMessageFromRaw : IFromRaw<InboundBulkMessage>
{
    /// <inheritdoc/>
