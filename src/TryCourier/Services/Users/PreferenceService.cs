...
public sealed class PreferenceService : IPreferenceService
{
    ...
    /// <inheritdoc/>
    public async Task<PreferenceBulkReplaceResponse> BulkReplace(
        PreferenceBulkReplaceParams parameters,
        CancellationToken cancellationToken = default
    )
    {
        using var response = await this
            .WithRawResponse.BulkReplace(parameters, cancellationToken)
            .ConfigureAwait(false);
        return await response.Deserialize(cancellationToken).ConfigureAwait(false);
    }

    /// <inheritdoc/>
    public Task<PreferenceBulkReplaceResponse> BulkReplace(
        string userID,
        PreferenceBulkReplaceParams parameters,
        CancellationToken cancellationToken = default
    )
    {
        return this.BulkReplace(parameters with { UserID = userID }, cancellationToken);
    }

    /// <inheritdoc/>
    public async Task<PreferenceBulkUpdateResponse> BulkUpdate(
        PreferenceBulkUpdateParams parameters,
        CancellationToken cancellationToken = default
    )
    {
        using var response = await this
            .WithRawResponse.BulkUpdate(parameters, cancellationToken)
            .ConfigureAwait(false);
        return await response.Deserialize(cancellationToken).ConfigureAwait(false);
    }

    /// <inheritdoc/>
    public Task<PreferenceBulkUpdateResponse> BulkUpdate(
        string userID,
        PreferenceBulkUpdateParams parameters,
        CancellationToken cancellationToken = default
    )
    {
        return this.BulkUpdate(parameters with { UserID = userID }, cancellationToken);
    }
...
public sealed class PreferenceServiceWithRawResponse : IPreferenceServiceWithRawResponse
{
    ...
    /// <inheritdoc/>
    public async Task<HttpResponse<PreferenceBulkReplaceResponse>> BulkReplace(
        PreferenceBulkReplaceParams parameters,
        CancellationToken cancellationToken = default
    )
    {
        ...
        HttpRequest<PreferenceBulkReplaceParams> request = new()
        {
        ...
        return new(
            ...
            async (token) =>
            {
                var deserializedResponse = await response
                    .Deserialize<PreferenceBulkReplaceResponse>(token)
                    .ConfigureAwait(false);
                if (this._client.ResponseValidation)
                {
    ...
    /// <inheritdoc/>
    public Task<HttpResponse<PreferenceBulkReplaceResponse>> BulkReplace(
        string userID,
        PreferenceBulkReplaceParams parameters,
        CancellationToken cancellationToken = default
    )
    ...
    /// <inheritdoc/>
    public async Task<HttpResponse<PreferenceBulkUpdateResponse>> BulkUpdate(
        PreferenceBulkUpdateParams parameters,
        CancellationToken cancellationToken = default
    )
    {
        ...
        HttpRequest<PreferenceBulkUpdateParams> request = new()
        {
        ...
        return new(
            ...
            {
                var deserializedResponse = await response
                    .Deserialize<PreferenceBulkUpdateResponse>(token)
                    .ConfigureAwait(false);
                if (this._client.ResponseValidation)
                {
                    deserializedResponse.Validate();
    ...
    /// <inheritdoc/>
    public Task<HttpResponse<PreferenceBulkUpdateResponse>> BulkUpdate(
        string userID,
        PreferenceBulkUpdateParams parameters,
        CancellationToken cancellationToken = default
    )
