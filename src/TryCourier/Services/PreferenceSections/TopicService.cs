...
public sealed class TopicService : ITopicService
{
    ...
    /// <inheritdoc/>
    public async Task<PreferenceTopicGetResponse> Create(
    ...
    /// <inheritdoc/>
    public Task<PreferenceTopicGetResponse> Create(
        string sectionID,
        TopicCreateParams parameters,
        CancellationToken cancellationToken = default
    )
    ...
    /// <inheritdoc/>
    public async Task<PreferenceTopicGetResponse> Retrieve(
    ...
    /// <inheritdoc/>
    public Task<PreferenceTopicGetResponse> Retrieve(
        string topicID,
        TopicRetrieveParams parameters,
        CancellationToken cancellationToken = default
    )
    ...
    /// <inheritdoc/>
    public async Task<PreferenceTopicListResponse> List(
    ...
    /// <inheritdoc/>
    public Task<PreferenceTopicListResponse> List(
        string sectionID,
    ...
    /// <inheritdoc/>
    public async Task<PreferenceTopicGetResponse> Replace(
    ...
    /// <inheritdoc/>
    public Task<PreferenceTopicGetResponse> Replace(
        string topicID,
        TopicReplaceParams parameters,
        CancellationToken cancellationToken = default
    )
...
public sealed class TopicServiceWithRawResponse : ITopicServiceWithRawResponse
{
    ...
    /// <inheritdoc/>
    public async Task<HttpResponse<PreferenceTopicGetResponse>> Create(
        TopicCreateParams parameters,
        CancellationToken cancellationToken = default
    )
    {
        ...
        return new(
            ...
            async (token) =>
            {
                var preferenceTopicGetResponse = await response
                    .Deserialize<PreferenceTopicGetResponse>(token)
                    .ConfigureAwait(false);
                if (this._client.ResponseValidation)
                {
                    preferenceTopicGetResponse.Validate();
                }
                return preferenceTopicGetResponse;
            }
        );
    }

    /// <inheritdoc/>
    public Task<HttpResponse<PreferenceTopicGetResponse>> Create(
        string sectionID,
        TopicCreateParams parameters,
        CancellationToken cancellationToken = default
    )
    ...
    /// <inheritdoc/>
    public async Task<HttpResponse<PreferenceTopicGetResponse>> Retrieve(
        TopicRetrieveParams parameters,
        CancellationToken cancellationToken = default
    )
    {
    ...
    /// <inheritdoc/>
    public Task<HttpResponse<PreferenceTopicGetResponse>> Retrieve(
        string topicID,
        TopicRetrieveParams parameters,
        CancellationToken cancellationToken = default
    )
    ...
    /// <inheritdoc/>
    public async Task<HttpResponse<PreferenceTopicListResponse>> List(
        TopicListParams parameters,
        CancellationToken cancellationToken = default
    )
    {
        ...
        return new(
            ...
            async (token) =>
            {
                var preferenceTopicListResponse = await response
                    .Deserialize<PreferenceTopicListResponse>(token)
                    .ConfigureAwait(false);
                if (this._client.ResponseValidation)
                {
                    preferenceTopicListResponse.Validate();
                }
                return preferenceTopicListResponse;
            }
        );
    }

    /// <inheritdoc/>
    public Task<HttpResponse<PreferenceTopicListResponse>> List(
        string sectionID,
        TopicListParams? parameters = null,
        CancellationToken cancellationToken = default
    )
    ...
    /// <inheritdoc/>
    public async Task<HttpResponse<PreferenceTopicGetResponse>> Replace(
        TopicReplaceParams parameters,
        CancellationToken cancellationToken = default
    )
    {
    ...
    /// <inheritdoc/>
    public Task<HttpResponse<PreferenceTopicGetResponse>> Replace(
        string topicID,
        TopicReplaceParams parameters,
        CancellationToken cancellationToken = default
    )
