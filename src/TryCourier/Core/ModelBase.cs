...
public abstract record class ModelBase
{
    ...
    internal static readonly JsonSerializerOptions SerializerOptions = new()
    {
        Converters =
        {
            ...
            new ApiEnumConverter<string, UnionMember0IntersectionMember1Type>(),
            new ApiEnumConverter<string, UnionMember1IntersectionMember1Type>(),
            new ApiEnumConverter<string, UnionMember2IntersectionMember1Type>(),
            new ApiEnumConverter<string, UnionMember3IntersectionMember1Type>(),
            new ApiEnumConverter<string, UnionMember4IntersectionMember1Type>(),
            new ApiEnumConverter<string, UnionMember5IntersectionMember1Type>(),
            new ApiEnumConverter<string, UnionMember6IntersectionMember1Type>(),
            new ApiEnumConverter<string, ElementalQuoteNodeWithTypeIntersectionMember1Type>(),
            new ApiEnumConverter<string, Align>(),
            ...
            new ApiEnumConverter<string, Journeys::JourneyAudienceTriggerNodeTriggerType>(),
            new ApiEnumConverter<string, Journeys::JourneyAudienceTriggerNodeType>(),
            ...
            new ApiEnumConverter<string, Journeys::Channel>(),
            ...
            new ApiEnumConverter<string, Journeys::JourneyWebhookTriggerNodeTriggerType>(),
            new ApiEnumConverter<string, Journeys::JourneyWebhookTriggerNodeType>(),
            ...
            new ApiEnumConverter<string, Digests::DigestDayOfWeek>(),
            new ApiEnumConverter<string, Digests::DigestFrequency>(),
            ...
            new ApiEnumConverter<string, Notifications::NotificationMetricsResponseGranularity>(),
