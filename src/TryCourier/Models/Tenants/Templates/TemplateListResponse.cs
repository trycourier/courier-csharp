...
public sealed record class TemplateListResponse : JsonModel
{
    ...
    /// </summary>
    public required ApiEnum<string, global::TryCourier.Models.Tenants.Templates.Type> Type
    {
        get
        {
            this._rawData.Freeze();
            return this._rawData.GetNotNullClass<
                ApiEnum<string, global::TryCourier.Models.Tenants.Templates.Type>
            >("type");
        }
...
sealed class TypeConverter : JsonConverter<global::TryCourier.Models.Tenants.Templates.Type>
{
    public override global::TryCourier.Models.Tenants.Templates.Type Read(
    ...
    )
    {
        ...
        {
            "list" => global::TryCourier.Models.Tenants.Templates.Type.List,
            _ => (global::TryCourier.Models.Tenants.Templates.Type)(-1),
        };
    }

    public override void Write(
        Utf8JsonWriter writer,
        global::TryCourier.Models.Tenants.Templates.Type value,
        JsonSerializerOptions options
    )
    {
        JsonSerializer.Serialize(
            ...
            value switch
            {
                global::TryCourier.Models.Tenants.Templates.Type.List => "list",
