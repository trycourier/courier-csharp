...
public sealed record class TenantAssociation : JsonModel
{
    ...
    public ApiEnum<string, global::TryCourier.Models.Tenants.Type>? Type
    {
        get
        {
            this._rawData.Freeze();
            return this._rawData.GetNullableClass<
                ApiEnum<string, global::TryCourier.Models.Tenants.Type>
            >("type");
        }
...
sealed class TypeConverter : JsonConverter<global::TryCourier.Models.Tenants.Type>
{
    public override global::TryCourier.Models.Tenants.Type Read(
    ...
    )
    {
        ...
        {
            "user" => global::TryCourier.Models.Tenants.Type.User,
            _ => (global::TryCourier.Models.Tenants.Type)(-1),
        };
    }

    public override void Write(
        Utf8JsonWriter writer,
        global::TryCourier.Models.Tenants.Type value,
        JsonSerializerOptions options
    )
    {
        JsonSerializer.Serialize(
            ...
            value switch
            {
                global::TryCourier.Models.Tenants.Type.User => "user",
