...
/// </summary>
public record class PreferenceSectionReplaceParams : ParamsBase
{
    ...
    public PreferenceSectionReplaceParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public PreferenceSectionReplaceParams(
        PreferenceSectionReplaceParams preferenceSectionReplaceParams
    )
        : base(preferenceSectionReplaceParams)
    {
        this.SectionID = preferenceSectionReplaceParams.SectionID;

        this._rawBodyData = new(preferenceSectionReplaceParams._rawBodyData);
    }
...
#pragma warning restore CS8618
    ...
    public static PreferenceSectionReplaceParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData,
        IReadOnlyDictionary<string, JsonElement> rawBodyData,
        string sectionID
    ...
    public virtual bool Equals(PreferenceSectionReplaceParams? other)
    {
        if (other == null)
        {
            return false;
