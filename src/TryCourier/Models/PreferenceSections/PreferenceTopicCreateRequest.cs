...
/// </summary>
[JsonConverter(
    typeof(JsonModelConverter<PreferenceTopicCreateRequest, PreferenceTopicCreateRequestFromRaw>)
)]
public sealed record class PreferenceTopicCreateRequest : JsonModel
{
    /// <summary>
    ...
    public PreferenceTopicCreateRequest() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public PreferenceTopicCreateRequest(PreferenceTopicCreateRequest preferenceTopicCreateRequest)
        : base(preferenceTopicCreateRequest) { }
#pragma warning restore CS8618

    public PreferenceTopicCreateRequest(IReadOnlyDictionary<string, JsonElement> rawData)
    {
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    PreferenceTopicCreateRequest(FrozenDictionary<string, JsonElement> rawData)
    {
        this._rawData = new(rawData);
    }
#pragma warning restore CS8618

    /// <inheritdoc cref="PreferenceTopicCreateRequestFromRaw.FromRawUnchecked"/>
    public static PreferenceTopicCreateRequest FromRawUnchecked(
...
class PreferenceTopicCreateRequestFromRaw : IFromRawJson<PreferenceTopicCreateRequest>
{
    /// <inheritdoc/>
    public PreferenceTopicCreateRequest FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawData
    ) => PreferenceTopicCreateRequest.FromRawUnchecked(rawData);
}
