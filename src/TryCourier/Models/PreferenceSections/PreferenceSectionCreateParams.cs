...
/// returned. Topics are created inside a section via POST /preferences/sections/{section_id}/topics.
///
/// <para>NOTE: Do not inherit from this type outside the SDK unless you're okay with
/// breaking changes in non-major versions. We may add new methods in the future that
/// cause existing derived classes to break.</para>
/// </summary>
public record class PreferenceSectionCreateParams : ParamsBase
{
    ...
    public PreferenceSectionCreateParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public PreferenceSectionCreateParams(
        PreferenceSectionCreateParams preferenceSectionCreateParams
    )
        : base(preferenceSectionCreateParams)
    {
        this._rawBodyData = new(preferenceSectionCreateParams._rawBodyData);
    }
...
#pragma warning restore CS8618
    ...
    public static PreferenceSectionCreateParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData,
        IReadOnlyDictionary<string, JsonElement> rawBodyData
    )
    ...
    public virtual bool Equals(PreferenceSectionCreateParams? other)
    {
        if (other == null)
        {
            return false;
    ...
    {
        return new UriBuilder(options.BaseUrl.ToString().TrimEnd('/') + "/preferences/sections")
        {
