...
/// </summary>
public record class JourneyCreateParams : ParamsBase
{
    ...
    public string? CancelationToken
    {
        ...
        {
            this._rawBodyData.Freeze();
            return this._rawBodyData.GetNullableClass<string>("cancelation_token");
        }
        init
        {
            if (value == null)
            ...
            this._rawBodyData.Set("cancelation_token", value);
        }
    }
    ...
    public JourneyCreateParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public JourneyCreateParams(JourneyCreateParams journeyCreateParams)
        : base(journeyCreateParams)
    {
        this._rawBodyData = new(journeyCreateParams._rawBodyData);
    }
...
#pragma warning restore CS8618
    ...
    public static JourneyCreateParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData,
        IReadOnlyDictionary<string, JsonElement> rawBodyData
    )
    ...
    public virtual bool Equals(JourneyCreateParams? other)
    {
        if (other == null)
        {
            return false;
    ...
    {
        return new UriBuilder(options.BaseUrl.ToString().TrimEnd('/') + "/journeys")
        {
