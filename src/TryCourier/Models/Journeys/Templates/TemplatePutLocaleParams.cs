...
/// </summary>
public record class TemplatePutLocaleParams : ParamsBase
{
    ...
    /// </summary>
    public ApiEnum<string, Notifications::NotificationTemplateState>? State
    {
        get
        {
            this._rawBodyData.Freeze();
            return this._rawBodyData.GetNullableClass<
                ApiEnum<string, Notifications::NotificationTemplateState>
            >("state");
        }
        init
        {
    ...
    public TemplatePutLocaleParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public TemplatePutLocaleParams(TemplatePutLocaleParams templatePutLocaleParams)
        : base(templatePutLocaleParams)
    {
        this.TemplateID = templatePutLocaleParams.TemplateID;
        this.NotificationID = templatePutLocaleParams.NotificationID;
        this.LocaleID = templatePutLocaleParams.LocaleID;

        this._rawBodyData = new(templatePutLocaleParams._rawBodyData);
    }
...
#pragma warning restore CS8618
    ...
    public static TemplatePutLocaleParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData,
        IReadOnlyDictionary<string, JsonElement> rawBodyData,
        string templateID,
    ...
    public virtual bool Equals(TemplatePutLocaleParams? other)
    {
        if (other == null)
        {
            return false;
    ...
    public override Uri Url(ClientOptions options)
    {
        return new UriBuilder(
            options.BaseUrl.ToString().TrimEnd('/')
                + string.Format(
                    "/journeys/{0}/templates/{1}/locales/{2}",
                    this.TemplateID,
                    this.NotificationID,
                    this.LocaleID
                )
