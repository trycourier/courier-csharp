...
/// matches the `channel` on the request — a journey-scoped template carries a single
...
/// so content stored without one cannot be opened. An empty `elements` array is accepted.</para>
///
