...
/// </summary>
public record class PreferenceDeleteTopicParams : ParamsBase
{
    ...
    public PreferenceDeleteTopicParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public PreferenceDeleteTopicParams(PreferenceDeleteTopicParams preferenceDeleteTopicParams)
        : base(preferenceDeleteTopicParams)
    {
        this.UserID = preferenceDeleteTopicParams.UserID;
        this.TopicID = preferenceDeleteTopicParams.TopicID;
    }
...
#pragma warning restore CS8618
    ...
    public static PreferenceDeleteTopicParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData,
        string userID,
        string topicID
    ...
    public virtual bool Equals(PreferenceDeleteTopicParams? other)
    {
        if (other == null)
        {
            return false;
