...
public sealed record class TenantListResponse : JsonModel
{
    ...
    /// </summary>
    public required ApiEnum<string, global::TryCourier.Models.Users.Tenants.Type> Type
    {
        get
        {
            this._rawData.Freeze();
            return this._rawData.GetNotNullClass<
                ApiEnum<string, global::TryCourier.Models.Users.Tenants.Type>
            >("type");
        }
...
sealed class TypeConverter : JsonConverter<global::TryCourier.Models.Users.Tenants.Type>
{
    public override global::TryCourier.Models.Users.Tenants.Type Read(
    ...
    )
    {
        ...
        {
            "list" => global::TryCourier.Models.Users.Tenants.Type.List,
            _ => (global::TryCourier.Models.Users.Tenants.Type)(-1),
        };
    }

    public override void Write(
        Utf8JsonWriter writer,
        global::TryCourier.Models.Users.Tenants.Type value,
        JsonSerializerOptions options
    )
    {
        JsonSerializer.Serialize(
            ...
            value switch
            {
                global::TryCourier.Models.Users.Tenants.Type.List => "list",
