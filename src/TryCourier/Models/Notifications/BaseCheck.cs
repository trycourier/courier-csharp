...
public sealed record class BaseCheck : JsonModel
{
    ...
    public required ApiEnum<string, global::TryCourier.Models.Notifications.Type> Type
    {
        get
        {
            this._rawData.Freeze();
            return this._rawData.GetNotNullClass<
                ApiEnum<string, global::TryCourier.Models.Notifications.Type>
            >("type");
        }
...
sealed class TypeConverter : JsonConverter<global::TryCourier.Models.Notifications.Type>
{
    public override global::TryCourier.Models.Notifications.Type Read(
        ref Utf8JsonReader reader,
        System::Type typeToConvert,
        JsonSerializerOptions options
    )
    {
        return JsonSerializer.Deserialize<string>(ref reader, options) switch
        {
            "custom" => global::TryCourier.Models.Notifications.Type.Custom,
            _ => (global::TryCourier.Models.Notifications.Type)(-1),
        };
    }

    public override void Write(
        Utf8JsonWriter writer,
        global::TryCourier.Models.Notifications.Type value,
        JsonSerializerOptions options
    )
    {
        JsonSerializer.Serialize(
            ...
            value switch
            {
                global::TryCourier.Models.Notifications.Type.Custom => "custom",
                _ => throw new CourierInvalidDataException(
                    string.Format("Invalid value '{0}' in {1}", value, nameof(value))
                ),
            },
