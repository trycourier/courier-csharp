...
/// </summary>
[JsonConverter(typeof(JsonModelConverter<PreviewRunDetail, PreviewRunDetailFromRaw>))]
public sealed record class PreviewRunDetail : JsonModel
{
    /// <summary>
    ...
    /// </summary>
    public required IReadOnlyList<PreviewResult> Results
    {
        get
        {
            this._rawData.Freeze();
            return this._rawData.GetNotNullStruct<ImmutableArray<PreviewResult>>("results");
        }
        init
        {
            this._rawData.Set<ImmutableArray<PreviewResult>>(
                "results",
                ImmutableArray.ToImmutableArray(value)
            );
        }
    ...
    public PreviewRunDetail() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public PreviewRunDetail(PreviewRunDetail previewRunDetail)
        : base(previewRunDetail) { }
#pragma warning restore CS8618

    public PreviewRunDetail(IReadOnlyDictionary<string, JsonElement> rawData)
    {
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    PreviewRunDetail(FrozenDictionary<string, JsonElement> rawData)
    {
        this._rawData = new(rawData);
    }
#pragma warning restore CS8618

    /// <inheritdoc cref="PreviewRunDetailFromRaw.FromRawUnchecked"/>
    public static PreviewRunDetail FromRawUnchecked(
...
class PreviewRunDetailFromRaw : IFromRawJson<PreviewRunDetail>
{
    /// <inheritdoc/>
    public PreviewRunDetail FromRawUnchecked(IReadOnlyDictionary<string, JsonElement> rawData) =>
        PreviewRunDetail.FromRawUnchecked(rawData);
}
