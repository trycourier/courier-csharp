...
public sealed record class DigestInstanceListResponse : JsonModel
{
    ...
    /// </summary>
    public required ApiEnum<string, global::TryCourier.Models.Digests.Type> Type
    {
        get
        {
            this._rawData.Freeze();
            return this._rawData.GetNotNullClass<
                ApiEnum<string, global::TryCourier.Models.Digests.Type>
            >("type");
        }
...
sealed class TypeConverter : JsonConverter<global::TryCourier.Models.Digests.Type>
{
    public override global::TryCourier.Models.Digests.Type Read(
    ...
    )
    {
        ...
        {
            "list" => global::TryCourier.Models.Digests.Type.List,
            _ => (global::TryCourier.Models.Digests.Type)(-1),
        };
    }

    public override void Write(
        Utf8JsonWriter writer,
        global::TryCourier.Models.Digests.Type value,
        JsonSerializerOptions options
    )
    {
        JsonSerializer.Serialize(
            ...
            value switch
            {
                global::TryCourier.Models.Digests.Type.List => "list",
