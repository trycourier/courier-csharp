...
/// and returns the new broadcast in the draft state. Exactly one channel is required.
///
...
#pragma warning restore CS8618
    ...
    {
        return new System::UriBuilder(options.BaseUrl.ToString().TrimEnd('/') + "/broadcasts")
        {
