...
/// </summary>
public record class BroadcastPutContentParams : ParamsBase
{
    ...
    public BroadcastPutContentParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public BroadcastPutContentParams(BroadcastPutContentParams broadcastPutContentParams)
        : base(broadcastPutContentParams)
    {
        this.BroadcastID = broadcastPutContentParams.BroadcastID;

        this._rawBodyData = new(broadcastPutContentParams._rawBodyData);
    }
...
#pragma warning restore CS8618
    ...
    public static BroadcastPutContentParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData,
        IReadOnlyDictionary<string, JsonElement> rawBodyData,
        string broadcastID
    ...
    public virtual bool Equals(BroadcastPutContentParams? other)
    {
        if (other == null)
        {
            return false;
    ...
    public override Uri Url(ClientOptions options)
    {
        return new UriBuilder(
            options.BaseUrl.ToString().TrimEnd('/')
                + string.Format("/broadcasts/{0}/content", this.BroadcastID)
        )
        {
