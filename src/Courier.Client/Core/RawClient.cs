...
internal partial class RawClient(ClientOptions clientOptions)
{
    ...
    internal Task<global::Courier.Client.Core.ApiResponse> MakeRequestAsync(
        global::Courier.Client.Core.BaseRequest request,
    ...
    internal async Task<global::Courier.Client.Core.ApiResponse> SendRequestAsync(
        global::Courier.Client.Core.BaseRequest request,
        CancellationToken cancellationToken = default
    )
    {
    ...
    /// </summary>
    private async Task<global::Courier.Client.Core.ApiResponse> SendWithRetriesAsync(
        HttpRequestMessage request,
        IRequestOptions? options,
    ...
    )
    {
        ...
        {
            return new global::Courier.Client.Core.ApiResponse
            {
    ...
    internal HttpRequestMessage CreateHttpRequest(global::Courier.Client.Core.BaseRequest request)
    {
    ...
    private static string BuildUrl(global::Courier.Client.Core.BaseRequest request)
    {
    ...
    /// <inheritdoc />
    [Obsolete("Use global::Courier.Client.Core.ApiResponse instead.")]
    internal record ApiResponse : global::Courier.Client.Core.ApiResponse;

    /// <inheritdoc />
    [Obsolete("Use global::Courier.Client.Core.BaseRequest instead.")]
    internal abstract record BaseApiRequest : global::Courier.Client.Core.BaseRequest;

    /// <inheritdoc />
    [Obsolete("Use global::Courier.Client.Core.EmptyRequest instead.")]
    internal abstract record EmptyApiRequest : global::Courier.Client.Core.EmptyRequest;

    /// <inheritdoc />
    [Obsolete("Use global::Courier.Client.Core.JsonRequest instead.")]
    internal abstract record JsonApiRequest : global::Courier.Client.Core.JsonRequest;

    /// <inheritdoc />
    [Obsolete("Use global::Courier.Client.Core.MultipartFormRequest instead.")]
    internal abstract record MultipartFormRequest
        : global::Courier.Client.Core.MultipartFormRequest;

    /// <inheritdoc />
    [Obsolete("Use global::Courier.Client.Core.StreamRequest instead.")]
    internal abstract record StreamApiRequest : global::Courier.Client.Core.StreamRequest;
}
