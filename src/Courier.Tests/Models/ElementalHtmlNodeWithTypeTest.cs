...
public class ElementalHtmlNodeWithTypeTest : TestBase
{
    [Fact]
    ...
    public void CopyConstructor_Works()
    {
        ...
        ElementalHtmlNodeWithType copied = new(model);

        Assert.Equal(model, copied);
    }
}

public class ElementalHtmlNodeWithTypeIntersectionMember1Test : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new ElementalHtmlNodeWithTypeIntersectionMember1
        {
            Type = ElementalHtmlNodeWithTypeIntersectionMember1Type.Html,
        };
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<ElementalHtmlNodeWithTypeIntersectionMember1>(
            json,
            ModelBase.SerializerOptions
        );
    ...
    public void CopyConstructor_Works()
    {
        ...
        ElementalHtmlNodeWithTypeIntersectionMember1 copied = new(model);

        Assert.Equal(model, copied);
    }
}

public class ElementalHtmlNodeWithTypeIntersectionMember1TypeTest : TestBase
{
    [Theory]
    [InlineData(ElementalHtmlNodeWithTypeIntersectionMember1Type.Html)]
    public void Validation_Works(ElementalHtmlNodeWithTypeIntersectionMember1Type rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, ElementalHtmlNodeWithTypeIntersectionMember1Type> value = rawValue;
        value.Validate();
    }
    ...
    [InlineData(ElementalHtmlNodeWithTypeIntersectionMember1Type.Html)]
    public void SerializationRoundtrip_Works(
        ElementalHtmlNodeWithTypeIntersectionMember1Type rawValue
    )
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, ElementalHtmlNodeWithTypeIntersectionMember1Type> value = rawValue;
